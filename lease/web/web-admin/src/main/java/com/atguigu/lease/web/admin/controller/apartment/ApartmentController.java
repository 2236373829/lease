...
public class ApartmentController {
    ...
    public Result saveOrUpdate(@RequestBody ApartmentSubmitVo apartmentSubmitVo) {
        boolean saveOrUpdate = service.saveOrUpdateApartment(apartmentSubmitVo);
        return Result.ok();
    }
    ...
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current,
        ...
        IPage<ApartmentItemVo> pageResult = service.pageItem(new Page<>(current, size), queryVo);
    ...
    public Result updateReleaseStatusById(@RequestParam Long id, @RequestParam ReleaseStatus status) {
        ...
        boolean update = service.update(apartmentUpdateWrapper);
