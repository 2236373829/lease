...
public class ApartmentInfoServiceImpl extends ServiceImpl<ApartmentInfoMapper, ApartmentInfo>
    ...
    public ApartmentItemVo selectApartmentItemVoById(Long apartmentId) {
        ...
        List<LabelInfo> labelInfoList = labelInfoMapper.selectByApartmentId(apartmentId);
        List<GraphVo> graphVoList = graphInfoMapper.selectByItemTypeAndItemId(ItemType.APARTMENT, apartmentId);
    ...
    public ApartmentDetailVo getApartmentDetailById(Long id) {
        ...
        //2.查询图片信息
        List<GraphVo> graphVoList = graphInfoMapper.selectByItemTypeAndItemId(ItemType.APARTMENT, id);
        //3.查询标签信息
